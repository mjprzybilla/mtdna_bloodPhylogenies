...
ggplot(ordered.foetal.mut.burden, aes(index, mutation_burden, color = Cell_type)) +
  ...
  theme(axis.text.x = element_text(angle=65, vjust=0.6)) + 
  labs(title="mtDNA mutation burden in foetal blood samples",
       x="Samples",
...
# ggsave("/Users/mp34/team154_campbell/plots/blood_foetal_mutation_burden.pdf", width = 10, height = 6, dpi = 600)
